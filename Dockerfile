...
RUN apt-get install -y gcc g++ gettext intltool \
gir1.2-gtk-3.0 libgtk2.0-dev liblcms2-dev libpng12-dev \
...
ENV PATH=/app/bin:/work/inst/bin:$PATH LD_LIBRARY_PATH=/app/lib:/work/inst/lib:$LD_LIBRARY_PATH
